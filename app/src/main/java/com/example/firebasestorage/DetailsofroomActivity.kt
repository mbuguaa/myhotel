...
class DetailsofroomActivity : ComponentActivity() {
...
fun Details(){
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        //TopAppBar
        TopAppBar(title = { Text(text = "Single room", color = Color.Black, fontSize = 25.sp, fontWeight = FontWeight.Bold) },
            navigationIcon = {
...
//            trailingIcon = { Icon(imageVector = Icons.Default.Check, contentDescription = "") },
        ...
        // Submit button
        Button(
            onClick = { mContext.startActivity(Intent(mContext,paymentDetailsActivity::class.java))
            },
            modifier = Modifier
                .padding(16.dp)
                .clickable {
                    mContext.startActivity(Intent(mContext,paymentDetailsActivity::class.java))
                },
